...
const ProjectCard : FC<Props> = ({project}) => {
    ...
    return (
        <Link href={`/catalogue/${project.id}`}>
            <div className="w-[275px] h-[400px] text-center bg-brand-gray outline outline-brand-dark border-8 border-brand-orange rounded-lg shadow-card shadow-brand-green/80 cursor-pointer">
